...
class AwsApiResourceIntegrationResponse extends AwsResourceAbstract
{
    public function getModelId(): string
    {
        return $this->getParent()->getParent()->getModelId() . '/' . $this->model['statusCode'];
    }

    public static function getResourceName(): string
    {
        return 'aws_resource_integration_response';
    }
    ...
    public function getExtraApiRequestParams(): array
    {
        return [
            ...
            'resourceId' => $this->getParent()->getParent()->getParent()->getModel()['id'],
